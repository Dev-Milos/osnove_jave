...
// ispred svake od njih se nalazi znak $. Ako u skripti postoji barem jedan znak $,
// to znači da još uvek postoje promenljive koje treba zameniti.
//
//Program od korisnika traži da unese naziv promenljive za zamenu i vrednost koja će
// biti postavljena umesto te promenljive u komandi.
...
//
        ...
        while (locust.contains("$")) {
            ...
            System.out.println("Unesite vrednost umesto te promenljive: ");
            String zamena = s.next();

            locust = locust.replace(promenljiva, zamena);

            System.out.println("Komanda: " + locust);
        }
