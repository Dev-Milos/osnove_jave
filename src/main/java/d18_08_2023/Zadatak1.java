...
// Iskoristite if/else za racunanje informacije i tek
// nakon te logike odstampajte vrednost y na ekranu.Funkcija y je definisana kao:
//    			       (x,       x < 2
//y =  (2,      2 <= x < 10
//    			       (x - 1, x >= 10
...
//y = -3
        ...
        System.out.println("Vrednost funckije y je : "+ y);
    }
