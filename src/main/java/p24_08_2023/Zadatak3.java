...
//Napomena: U zadataku nakon kreiraanja niza, ne treba da se
// desi kod koji setuje fiksne vrednosti u niz.
        ...
        int prvi = numbers.get(0);

        int zadnji = numbers.get(numbers.size()-1);

        numbers.set(0, zadnji);
        numbers.set(numbers.size()-1, prvi);
